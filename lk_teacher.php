...
echo "<form action='otchet.php' method='post'>
<button name='creat_otchet'>отчеты</button>
...
echo "<form  action='ADDabs.php'method='post' name='addabsence'>
	<input type='submit' name='dobavlenie' value='Добавить пропуск' class='propusk'></form>";
...
<button name='otchet' OnClick='window.print()'>Печать</button>
		...
		echo "<form  action='ADDabs.php'method='post' name='addabsence'>
	<input type='submit' name='dobavlenie' value='Добавить пропуск'>


	</form>";
	echo "<form action='' name='' method='post'> 
				<button name='otchet'>Отчет</button>	
			</form>";
